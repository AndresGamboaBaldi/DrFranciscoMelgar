...
const barber_vip: Professional = {
  ...
  shortName: 'VIP Barber Studio',
  title: 'Barbería Exclusiva',
  specialty: 'Asesores de Imagen Masculina',
  location: 'Cochabamba, Bolivia',
  ...
  bio: 'VIP Barber Studio nació con la visión de traer a Cochabamba una experiencia de barbería de lujo: ambiente premium, técnicas modernas y atención personalizada. Nuestro equipo de barberos certificados se especializa en cortes clásicos, fade y diseño de barba.',
  credentials: [
  ...
  services: [
    {
      ...
      durationMins: 60,
      description:
        'Asesoramiento personalizado de acuerdo a tu estilo',
    ...
    },
    {
      ...
      durationMins: 60,
      description:
        'Corte personalizado más perfilado de barba',
    ...
    },
    {
      ...
      durationMins: 120,
      description:
        'Corte a tu estilo más tinte profesional de barba. (Ideal para cubrir canas)',
    ...
    {
      id: 'ondulacion',
      name: 'Ondulación Permanente + Corte',
      tag: 'Estilo',
      price: 'Desde Bs. 250',
      durationMins: 120,
      description:
    ...
    },
    {
      ...
      durationMins: 60,
      description:
        'Exfoliación, vapor y mascarilla para renovar tu piel.',
  ...
  staff: [
    ...
    },*/
    {
    ...
    },
     {
      ...
      title: 'Barbero Profesional',
      photo: '/barber_vip/photos/rey.jpeg',
      phone: '59177425356',
