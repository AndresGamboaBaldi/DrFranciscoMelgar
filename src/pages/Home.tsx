...
export default function Home() {
  useEffect(() => {
    ...
    link.rel = 'stylesheet'
    link.href =
      'https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Inter:wght@300;400;500;600&family=Playfair+Display:ital,wght@0,400;1,400&display=swap'
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Comparte tu enlace y deja que tus clientes agenden solos mientras tú te enfocas en tu
          trabajo.
        </p>
        ...
        <div className="benefit-bento">
          {FEATURES.map((f, i) => (
            <Reveal
              ...
              delay={i * 80}
              as="div"
              className={`benefit-card benefit-card-${i + 1}`}
              style={undefined as never}
            >
              <span className="benefit-card-num">{String(i + 1).padStart(2, '0')}</span>
              <div className="benefit-card-icon" style={{ color: GOLD, marginBottom: '1rem' }}>
              ...
              <p style={{ fontSize: '1rem', color: 'rgba(255,255,255,.6)', lineHeight: 1.7 }}>
                {f.desc}
              </p>
            </Reveal>
          ))}
              ...
              return (
                <Reveal key={s.n} delay={i * 100} as="div" style={undefined as never}>
                  ...
                  >
                    {/* Text */}
                    <div
                      style={{ order: reverse ? 2 : 1, textAlign: reverse ? 'left' : 'right' }}
            ...
            <Reveal key={plan.name} delay={i * 80} as="div" style={undefined as never}>
              <div
                style={{
                  ...
                  flexDirection: 'column',
                  padding: '2.5rem 2rem',
                  background: plan.tag ? 'linear-gradient(160deg, #1d1813, #0e0c0a)' : '#0e0c0a',
              ...
              >
                ...
                <p style={{ marginBottom: '1.75rem' }}>
                  ...
                  <span style={{ fontSize: '1.2rem', color: 'rgba(255,255,255,.5)' }}>
                    {plan.period}
                  </span>
                </p>
                <ul
                ...
                <a
                  href={waLink(`Hola! Me interesa el plan ${plan.name} de Probo.pro`)}
                  style={{
                    display: 'inline-flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                    ...
                    padding: '.9rem 1.5rem',
                    textAlign: 'center',
                    background: plan.tag ? GOLD : 'transparent',
                    color: plan.tag ? '#0a0907' : '#fff',
                  ...
                  onMouseEnter={(e) => {
                    if (plan.tag) e.currentTarget.style.background = GOLD_L
                    else {
                  ...
                  onMouseLeave={(e) => {
                    if (plan.tag) e.currentTarget.style.background = GOLD
                    else {
      ...
      >
        ...
        <p style={{ fontSize: '.9rem', color: 'rgba(255,255,255,.4)' }}>
          © {new Date().getFullYear()} Probo.pro — Reservas online para profesionales en Bolivia
        </p>
      </footer>
    </div>
  )
